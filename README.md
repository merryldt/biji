# 学习笔记
## java
- [RSA 解密优化-单例模式-同步关键字（synchronized）-volatile关键字的使用](https://github.com/florarose/biji/blob/master/Java/rsa%E8%A7%A3%E5%AF%86%E4%BC%98%E5%8C%96.md)
- [Volatile关键字的初步认识](https://github.com/florarose/biji/blob/master/Java/Volatile.md)
...
## java编程思想
## Effctive_java
- [使用静态工厂方法替代构造方法](https://github.com/florarose/biji/blob/master/Effctive/Effctive_java_01.md)
## Springboot系列
- [Springboot整合Junit-单元测试](https://github.com/florarose/biji/blob/master/Springboot/Junit.md)
- [SpringBoot整合Fastjson-处理返回值的问题](https://github.com/florarose/biji/blob/master/Springboot/SpringBoot_Fastjson.md)
- [SpringBoot处理默认Jackson-处理返回值的问题](https://github.com/florarose/biji/blob/master/Springboot/Springboot_Jackson.md)
- [SpringBoot整合@JsonView注解](https://github.com/florarose/biji/blob/master/Springboot/JsonView.md)
## Docker
- [Docker 安装MySQL 主从复制 、Redis 、nginx 、安装maven,和java 配置开发环境](https://github.com/florarose/biji/blob/master/Docker/docker.md)
